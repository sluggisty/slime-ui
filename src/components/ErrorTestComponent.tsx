...
export const ErrorTestComponent: React.FC = () => {
  ...
  return (
    <div style={{ padding: '1rem', border: '1px solid #ccc', borderRadius: '8px' }}>
      ...
      <div style={{ marginBottom: '1rem' }}>
        <button onClick={execute} disabled={loading} style={{ marginRight: '0.5rem' }}>
      ...
      <div style={{ fontSize: '0.8rem', color: '#666' }}>
        ...
        <ul>
          <li>
            <strong>Network/Auth/Server Errors:</strong> Async operation failures with automatic
            retry
          </li>
          <li>
            <strong>Render/Reference/Type Errors:</strong> Synchronous errors caught by error
            boundaries
          </li>
          <li>
            <strong>Error Recovery:</strong> Automatic retry with exponential backoff
          </li>
        </ul>
      </div>
    </div>
