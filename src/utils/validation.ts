 ...
 */
export function validateLoginData(data: { username: string; password: string }): ValidationResult {
  const errors: string[] = [];
 ...
 */
export function validateApiKeyData(data: { name: string; expires_at?: string }): ValidationResult {
  const errors: string[] = [];
